...
public class Ejercicio6 {
    ...
    // voy a comprobar si ya hay datos para ello, miro si hay cabeceras por eso se usa una u otra
    ...
    public static void leerObjetos() {
        try {
            ...
            ObjectInputStream oIS = new ObjectInputStream(new FileInputStream(new File(Ejercicio3.RUTADATOS + DATOSFILEOUT)));
            try {
                while (true) {
